...
Preload.prototype.preload = function () {
	...
	if (this.game.device.desktop) {
		if (!pConfig.enableDebug) console.warn( 'DEBUG is disabled' );
		else {
	...
	_progress_bar.scale.set(5.0, 1.0);
	_progress_bar.pivot.set(0.0, 5.0);
	_progress_bar.anchor.set(0.0, 0.5);
...
Preload.prototype.loadCustomPacks = function () {
	this.load.customPack( 'custom_pack', 'customCommon', this.onCustomLoadComplete, this );
};

Preload.prototype.onCustomLoadComplete = function () {
	console.log( 'onCustomLoadComplete' );
